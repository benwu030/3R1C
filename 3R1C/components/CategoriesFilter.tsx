...
export const MainCategoriesFilter = ({
  Categories,
}: {
  Categories: string[];
}) => {
  ...
  return (
    ...
    >
      {Categories.map((category, index) => (
        ...
        >
          <Text
            className={`text-sm  ${selectedCategory === category ? "text-white font-S-Bold " : " font-S-Regular "}`}
          >
            {category}
          </Text>
        </TouchableOpacity>
  ...
  return (
    ...
    >
      {Categories.map((category, index) => (
        ...
        >
          <Text
            className={`text-sm  ${selectedCategories.includes(category) ? "text-white font-S-Bold " : " font-S-Regular "}`}
          >
            {category}
          </Text>
        </TouchableOpacity>
